/*
	...
	- Ejercicio N°4 - Sockets 2048B - Cliente
...
#define MAX_DATOS 2048	// tamaño máximo de datos leídos desde el servidor.
...
int main(int argc, char *argv[])
{
	...
	// imprimir lo leído
	for (int j = 0; j < MAX_DATOS/64; ++j) {
		for (int i = 0; i < MAX_DATOS/32; ++i)
			printf("%i", buffer[j]);
		printf("\n");
	}
